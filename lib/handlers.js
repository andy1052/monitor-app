				...
				if (!err && userData) {
					...
					if (hashedPassword === userData.hashedPassword) {
						...
						_data.create('tokens', tokenId, tokenObject, (err) => {
							...
							_performance.measure('Validating user input', 'endtered function', 'inputs validated');
					...
					_data.read('users', userPhone, function(err, userData) {
						if (!err && userData) {
							...
							if (userChecks.length < config.maxChecks) {
								...
								//	Verify that the url given has url entries and therefore can resolve
